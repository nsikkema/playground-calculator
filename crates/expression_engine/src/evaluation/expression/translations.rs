...
/// Returns translations for every expression-engine diagnostic.
#[must_use]
pub fn get_error_message_translations() -> SharedStringTranslationMap {
    let translations = SharedStringTranslationMap::new();
    translations.set_translation_key(
